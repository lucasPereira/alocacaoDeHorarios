...
abstract class EntityRowTableModel<T extends BaseEntity> extends AbstractTableModel
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3685153163208891965L;
	 ...
	 *							of the new columns
	 */
	protected EntityRowTableModel(List<String> columnNames)
	{
	 ...
	 *							of the new columns
	 */
	protected EntityRowTableModel(List<T> modelData, List<String> columnNames)
	{
...
//
	...
	/**
	 *  Adds the specified rows of data to the end of the model.
	 *  Notification of the row being added will be generated.
	 *
	 * @param   rowsData		 data of the rows being added
	 */

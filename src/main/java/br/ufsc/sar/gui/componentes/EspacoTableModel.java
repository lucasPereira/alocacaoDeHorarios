...
public class EspacoTableModel extends EntityRowTableModel<Espaco> {
	...
	@Override
	public Class<Espaco> getColumnClass(int column) {
	...
	public void setValueAt(Object value, int row, int column)
	{
		...
		{
		case 0:
			espaco.setId((Long) value);
			break;
		case 1:
			espaco.setNome((String) value);
			break;
		case 2:
			espaco.setDescricao((String) value);
			break;
		case 3:
			espaco.setCapacidade((Long) value);
			break;
		case 4:
			espaco.setForauso((Boolean) value);
			break;
		case 5:
			break;
		case 6:

...
public class CaracteristicaServiceImpl extends BaseServiceImpl<Caracteristica> implements CaracteristicaService {
	...
	public List<Caracteristica> getListAtivas() {
		...
		try {
			listCaracteristica = (List<Caracteristica>) super.getEntityManager().createQuery(sql.toString(), Caracteristica.class).getResultList();
	...
	public List<Caracteristica> getListPorNome(String nome) {
		...
		try {
			listCaracteristica = super.getEntityManager().createQuery(sql.toString(), Caracteristica.class).setParameter("nome", nome.toUpperCase()).getResultList();
		} catch (NoResultException e) {
